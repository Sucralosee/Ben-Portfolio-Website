    ...
    return (
        <>
            ...
            <div className="Timber-main-container" ref={el => fadeRefs.current[1] = el}>
                <div className="left-overview" ref={el => fadeRefs.current[2] = el}>
                    ...
                    <p className="SubHead role-overview"> My Role</p>
                        <h2 className="Pop28">Editorial Design</h2>
                        <p className="Pop20">
                        ...
                        <h2 className="Pop28">Research</h2>
                        <p className="Pop20">
                        ...
                        <h2 className="Pop28">Layout Design</h2>
                        <p className="Pop20">
            ...
            <div className="timber-container">
                <img src="/image/timber/TimberSpreadsMag.png"/>
            </div>
            <div className="timber-container">
                <iframe src="https://indd.adobe.com/embed/44584cf8-4349-4ad7-b5fb-497ac28fd021?startpage=1&allowFullscreen=true" className="timber-frame" frameborder="0" allowfullscreen=""></iframe>
            </div>        
        </>
    )
}
